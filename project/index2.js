...
import { loadObj } from './js/main.js';

export var cameraPositionMain = m4.identity()
export var fov = 50;
export var lightx = 50;
export var lighty = 50;
export var lightz = 50;

export var velocity = 10
export var planeCamera = m4.identity()
export var sound_plane = new Audio('aereo.mp3');
export var turbo_plane = new Audio('turbo.mp3');
